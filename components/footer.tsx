...
const socials = ["linkedin", "instagram", "vimeo", "youtube", "sound"];
  ...
  return (
    <footer>
      <div className="grid items-center gap-6 bg-black/75 p-6 text-[#F5F5F5] md:grid-cols-3">
        ...
        <div className="fixed right-6 bottom-6 z-10 -translate-y-2 font-akira text-sm text-white/75 mix-blend-exclusion md:-translate-y-1 md:text-base">
          contatti
        </div>
      </div>
    </footer>
